...
3. Choose **App Registration** or **Managed Identity (Manual)**
4. Enter your Azure authentication details:
   - Subscription ID  
   - Tenant ID  
   - Client ID  
   - Client Secret
5. Name it: `DemoConnection`
...
**Note**: No need to add an agent manually — the infra setup will do that.
