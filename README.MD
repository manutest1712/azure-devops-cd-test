...
From the Azure DevOps **Pipelines → Environments** page:
...
#### 2️⃣ Run the Registration Script on the VM
...
>💡 Tip: It may take a few seconds for the VM to appear; refresh the page if needed.
---
